...
namespace Nextlabs.SFBServerEnforcer.HTTPComponent.Policy
{
    ...
    class CondtionObligationEvaluation
    {
        ...
        private static ConditionEvaluationResult DoEvalutionForParticipateCondtions(List<PolicyObligation> lstOb, List<string> lstParticipate)
        {
            ...
            int nPolicyQueryResult = HttpPolicy.GetInstance().QueryPolicyForUserConditionObligation(lstParticipate, lstConditions, out arrayPolicyResult);
