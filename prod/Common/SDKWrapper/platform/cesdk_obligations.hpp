...
namespace nextlabs
{
  ...
  class Obligation
  {
    public:
       ...
       */
      bool GetObligationValue( __in  const wchar_t* ob_key ,
	...
	return false;
       ...
       */
      bool IsObligationSet( __in const wchar_t* ob_key ) const
      {
	assert( ob_key != NULL );
	if( ob_key == NULL )
	{
  ...
  class Obligations
  {
    public:
       ...
       */
      static bool GetValue( __in const WCHAR* (*pfn_CEM_GetString)(CEString) ,
	...
	return false;
       ...
       */
      void Assign( __in const WCHAR* (*pfn_CEM_GetString)(CEString) ,
		   CEAttributes& obligations )
      {
	assert( pfn_CEM_GetString != NULL );
	...
	return obs.end();
       ...
       */
      bool IsObligationSet( __in const wchar_t* ob_name ) const
      {
	assert( ob_name != NULL );
	if( ob_name == NULL )
	{
