...
namespace nextlabs
{
  ...
  class cesdk_attributes
  {
     ...
     *  \sa destroy
     */
    __checkReturn static CEAttributes* create(void) throw()
    {
     ...
     *  \sa create, destroy
     */
    __checkReturn static bool add( const nextlabs::cesdk_loader& cesdk ,
				   __in CEAttributes* in_attrs ,
				   __in const wchar_t* in_key ,
				   __in const wchar_t* in_value ) throw()
    {
    ...
    static void destroy( const nextlabs::cesdk_loader& cesdk ,
			 __in CEAttributes* in_attrs ) throw()
    {
