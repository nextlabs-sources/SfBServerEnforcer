...
namespace NLUCMA
{
    ...
    public static class UCMAHelper
    {
        ...
        {
            theLog.OutputLog(EMSFB_LOGLEVEL.emLogLevelDebug, "Begin shutdown platform\n");
            ...
            theLog.OutputLog(EMSFB_LOGLEVEL.emLogLevelDebug, "Success shutdown platform\n");
        }

        public static void TerminateCall(InstantMessagingCall obIMCall, AsyncCallback CBFuncTerminateCallComplete)
        {
            theLog.OutputLog(EMSFB_LOGLEVEL.emLogLevelDebug, "Begin terminate call");
            ...
            theLog.OutputLog(EMSFB_LOGLEVEL.emLogLevelDebug, "Success terminate call");
        }
        
        public static void TerminateConversation(Conversation obConversation, AsyncCallback CBFuncTerminateConversationComplete)
        {
            theLog.OutputLog(EMSFB_LOGLEVEL.emLogLevelDebug, "Begin terminate conversation");
            ...
            theLog.OutputLog(EMSFB_LOGLEVEL.emLogLevelDebug, "Success terminate conversation");
        }

        public static void TerminateUserEndpoint(UserEndpoint obUserEndpoint, AsyncCallback CBFuncTerminateUserEndpointComplete)
        {
            theLog.OutputLog(EMSFB_LOGLEVEL.emLogLevelDebug, "Begin terminate user endpoint");
            IAsyncResult obAysncResult = obUserEndpoint.BeginTerminate(CBFuncTerminateUserEndpointComplete, obUserEndpoint);
            if (null == CBFuncTerminateUserEndpointComplete)
            {
                obUserEndpoint.EndTerminate(obAysncResult);
            }
            theLog.OutputLog(EMSFB_LOGLEVEL.emLogLevelDebug, "Success terminate user endpoint");
        }
    }
}
