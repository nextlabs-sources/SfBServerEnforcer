...
namespace SFBCommon.Common
{
    public enum EMSFB_INFOTYPE
    {
        ...
        emInfoCommonConfigure,

        emInfoSFBFileStoreService,
        emInfoSFBPersistentChatServer,

        emInfoSFBChatCategory,
        emInfoSFBChatRoom,
        emInfoSFBChatRoomVariable,
        emInfoSFBMeeting,
        emInfoSFBMeetingVariable,
        emInfoSFBMeetingShare,

        emInfoNLChatCategory,
        emInfoNLChatRoom,
        emInfoNLMeeting,

        emInfoSFBUserInfo,

        emInfoNLAssistantServiceInfo,
        emInfoNLAssistantQueryPolicyInfo,

        emInfoSFBChatRoomAttachmentEntryVariable,
        emInfoNLChatRoomAttachment,

        emInfoNLTagLabel,
        emInfoNLClassificationSchema
    }
    ...
    public interface IPersistentStorage : IDisposable
    {
        ...
        bool DeleteObjInfo(EMSFB_INFOTYPE emInfoType, string strKeyValue);
