...
namespace SFBCommon.CommandHelper
{
    ...
    public enum EMSFB_COMMAND
    {
        ...
        emCommandNotify,
        emCommandClassifyMeeting,
        emCommandClassifyChatRoom,      // Back up, currently IMAgent module do not support to classify chat room
    ...
    public abstract class CommandHelper
    {
        ...
        public const string kstrWildcardFileName = "FILENAME";
        public const string kstrWildcardFileOwner = "FILEOWNER";
        public const string kstrWildcardFileTag = "FILETAG";
        ...
        public const string kstrCommandNotify = "notify";
        public const string kstrCommandClassifyMeeting = "classifyMeeting";
        public const string kstrCommandClassifyChatRoom = "classifyChatRoom";
        ...
        public static readonly Dictionary<EMSFB_COMMAND, string> kdicCommandTypes = new Dictionary<EMSFB_COMMAND, string>()
        {
            ...
            { EMSFB_COMMAND.emCommandNotify, kstrCommandNotify },
            { EMSFB_COMMAND.emCommandClassifyMeeting, kstrCommandClassifyMeeting },
            { EMSFB_COMMAND.emCommandClassifyChatRoom, kstrCommandClassifyChatRoom },
        ...
        {
            EMSFB_COMMAND emCommandType = EMSFB_COMMAND.emCommandUnknown;
            if (kstrCommandNotify.Equals(strCommandType, StringComparison.OrdinalIgnoreCase))
            {
                emCommandType = EMSFB_COMMAND.emCommandNotify;
            }
            else if (kstrCommandClassifyMeeting.Equals(strCommandType, StringComparison.OrdinalIgnoreCase))
            {
                emCommandType = EMSFB_COMMAND.emCommandClassifyMeeting;
            }
            else if (kstrCommandClassifyChatRoom.Equals(strCommandType, StringComparison.OrdinalIgnoreCase))
            {
                emCommandType = EMSFB_COMMAND.emCommandClassifyChatRoom;
            }
            else if (kstrCommandGetEndpointProxyInfo.Equals(strCommandType, StringComparison.OrdinalIgnoreCase))
            {
