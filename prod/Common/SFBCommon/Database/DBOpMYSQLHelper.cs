...
namespace SFBCommon.Database
{
    class DBOpMYSQLHelper : AbstractDBOpHelper
    {
        ...
        override protected string GetModifyColumnTypeSqlCommand(string strTableName, string strFieldName, string strFieldType)
        {
            // ALTER TABLE TableName MODIFY COLUMN fieldName1 fieldType, MODIFY COLUMN fieldName2 fieldType
            return string.Format("ALTER TABLE {0} MODIFY COLUMN {1} {2}", strTableName, strFieldName, strFieldType);
        }
        #endregion
